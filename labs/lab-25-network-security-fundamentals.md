# Lab 25 — Network Security Fundamentals

## Lab Objective

Apply the concepts from Lesson 25 in a safe, isolated training environment and practice security-focused troubleshooting.
...
Build or reuse a segmented Packet Tracer network. Identify assets, trust boundaries, likely risks, and where you would apply physical, technical, and administrative controls. Create VLANs for USERS, IT, SERVERS, and GUESTS if they are not already present. Document which traffic should be permitted between them and why.
...
You have completed **Lab 25 — Network Security Fundamentals**.

# Next Lesson

➡️ **[Lesson 26 — Firewalls](../lessons/lesson-26-firewalls.md)**
