# Lab 39 — Troubleshooting Switching and Routing

## Lab Objective

Practice troubleshooting switching and routing using a repeatable, evidence-based IT troubleshooting workflow.
...
Use the segmented Section 5-style topology. Create faults involving an access VLAN, trunk, router subinterface/SVI, static route, and physical uplink. Use `show interfaces status`, `show mac address-table`, `show vlan brief`, `show interfaces trunk`, `show spanning-tree`, `show ip interface brief`, and `show ip route` as appropriate.
...
You have completed **Lab 39 — Troubleshooting Switching and Routing**.

# Next Lesson

➡️ **[Lesson 40 — Network Documentation and Monitoring](../lessons/lesson-40-network-documentation-and-monitoring.md)**
