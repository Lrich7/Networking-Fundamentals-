# Lab 36 — Packet Analysis

## Lab Objective

Practice packet analysis using a repeatable, evidence-based IT troubleshooting workflow.
...
Use a safe training capture or your own isolated traffic. Identify an ARP exchange, DNS query/response, TCP three-way handshake, and connection teardown or failure if available. Correlate packet timestamps and flags with the user-visible event.
...
You have completed **Lab 36 — Packet Analysis**.

# Next Lesson

➡️ **[Lesson 37 — Troubleshooting Connectivity](../lessons/lesson-37-troubleshooting-connectivity.md)**
