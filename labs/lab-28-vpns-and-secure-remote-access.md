# Lab 28 — VPNs and Secure Remote Access

## Lab Objective

Apply the concepts from Lesson 28 in a safe, isolated training environment and practice security-focused troubleshooting.
...
Diagram both a remote-access VPN and a site-to-site VPN. Identify endpoints, authentication, encrypted tunnel, protected networks, and routing requirements. If your Packet Tracer version supports an appropriate VPN exercise, build it; otherwise complete the design and troubleshooting portion without forcing unsupported commands.
...
You have completed **Lab 28 — VPNs and Secure Remote Access**.

# Next Lesson

➡️ **[Lesson 29 — Wireless Security](../lessons/lesson-29-wireless-security.md)**
