# Lab 35 — Wireshark Fundamentals

## Lab Objective

Practice wireshark fundamentals using a repeatable, evidence-based IT troubleshooting workflow.
...
Capture only traffic you are authorized to inspect. Generate safe ICMP and DNS traffic and apply display filters such as `icmp`, `dns`, `tcp`, and `arp`. Locate packet layers and compare source/destination addresses. Never upload production captures to a public repository.
...
You have completed **Lab 35 — Wireshark Fundamentals**.

# Next Lesson

➡️ **[Lesson 36 — Packet Analysis](../lessons/lesson-36-packet-analysis.md)**
