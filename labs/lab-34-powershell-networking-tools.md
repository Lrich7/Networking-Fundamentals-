# Lab 34 — PowerShell Networking Tools

## Lab Objective

Practice powershell networking tools using a repeatable, evidence-based IT troubleshooting workflow.
...
Practice `Get-NetAdapter`, `Get-NetIPConfiguration`, `Get-NetRoute -AddressFamily IPv4`, `Test-NetConnection`, `Resolve-DnsName`, and `Get-NetTCPConnection`. Build a short PowerShell network-health collection script that only reads configuration and connectivity information.
...
You have completed **Lab 34 — PowerShell Networking Tools**.

# Next Lesson

➡️ **[Lesson 35 — Wireshark Fundamentals](../lessons/lesson-35-wireshark-fundamentals.md)**
