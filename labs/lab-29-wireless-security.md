# Lab 29 — Wireless Security

## Lab Objective

Apply the concepts from Lesson 29 in a safe, isolated training environment and practice security-focused troubleshooting.
...
Create a Packet Tracer wireless network with a legitimate SSID and secure authentication supported by your version. Add a separate guest design. Compare secure and insecure configurations, but perform all testing only in your isolated lab. Document why WPA3/WPA2 with strong authentication is preferred over obsolete wireless security.
...
You have completed **Lab 29 — Wireless Security**.

# Next Lesson

➡️ **[Lesson 30 — Network Threats and Attacks](../lessons/lesson-30-network-threats-and-attacks.md)**
