# Lab 37 — Troubleshooting Connectivity

## Lab Objective

Practice troubleshooting connectivity using a repeatable, evidence-based IT troubleshooting workflow.
...
Use Packet Tracer to create six connectivity faults: physical disconnect, wrong IP, wrong mask, wrong gateway, missing route, and unavailable application service. Diagnose each using a bottom-up workflow and record the evidence that isolated the cause.
...
You have completed **Lab 37 — Troubleshooting Connectivity**.

# Next Lesson

➡️ **[Lesson 38 — Troubleshooting DNS and DHCP](../lessons/lesson-38-troubleshooting-dns-and-dhcp.md)**
