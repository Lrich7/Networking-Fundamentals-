# Lab 27 — Access Control Lists

## Lab Objective

Apply the concepts from Lesson 27 in a safe, isolated training environment and practice security-focused troubleshooting.
...
In Packet Tracer, create two user networks and one server network. Configure an ACL that permits a required service while restricting an unnecessary path. Verify before and after with `show access-lists`, appropriate interface checks, ping, and application tests. Practice the implicit-deny concept and remove the ACL after the isolated exercise if needed.
...
You have completed **Lab 27 — Access Control Lists**.

# Next Lesson

➡️ **[Lesson 28 — VPNs and Secure Remote Access](../lessons/lesson-28-vpns-and-secure-remote-access.md)**
