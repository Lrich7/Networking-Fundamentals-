# Lab 40 — Network Documentation and Monitoring

## Lab Objective

Practice network documentation and monitoring using a repeatable, evidence-based IT troubleshooting workflow.
...
Take a completed Packet Tracer topology and create professional network documentation: logical topology, device inventory, IP plan, VLAN list, trunk/uplink list, gateway table, service list, baseline tests, monitoring targets, alert/escalation notes, and a change log.
...
You have completed **Lab 40 — Network Documentation and Monitoring**.

# 🛠️ Project 07 — Network Troubleshooting Capstone

You have completed the final lesson and lab sequence.

Now apply the entire course in the capstone.

➡️ **[Project 07 — Network Troubleshooting Capstone](../projects/project-07-network-troubleshooting-capstone.md)**

➡️ **[Begin Project 07 — Network Troubleshooting Capstone](../projects/project-07-network-troubleshooting-capstone.md)**
