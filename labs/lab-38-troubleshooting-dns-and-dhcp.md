# Lab 38 — Troubleshooting DNS and DHCP

## Lab Objective

Practice troubleshooting dns and dhcp using a repeatable, evidence-based IT troubleshooting workflow.
...
Build or reuse a Packet Tracer DHCP/DNS network. Create four faults: DHCP disabled, exhausted/invalid pool, wrong DNS server option, and incorrect DNS record. Prove whether each problem is addressing, name resolution, routing, or service related.
...
You have completed **Lab 38 — Troubleshooting DNS and DHCP**.

# Next Lesson

➡️ **[Lesson 39 — Troubleshooting Switching and Routing](../lessons/lesson-39-troubleshooting-switching-and-routing.md)**
